...
Annotation = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      name:
          ...
          ct_id_or_number}/incidents/{incident_id}/annotations/{annotati
          on_id}”.
      author:
...
IncidentRoleAssignment = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      name:
          ...
          mber}/incidents/{incident_id}/role_assignments/{role_id}”.
      etag:
...
Artifact = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      name:
          Output only. Resource name such as “projects/{project_id_or_nu
          mber}/incidents/{incident_id}/artifacts/{artifact_id}”.
      display_name:
...
Subscription = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      name:
          Output only. Resource name such as “projects/{project_id_or_nu
          mber}/incidents/{incident_id}/subscriptions/{subscription_id}”
          .
      etag:
          Output only. Etag for this version of the resource. Must be
          specified in update requests and match the current version in
